...
namespace Vector3
{
	...
	inline XMFLOAT3 ScalarProduct(XMFLOAT3& xmf3Vector, float fScalar, bool bNormalize = true) {
		...
		if (bNormalize)
			...
			XMStoreFloat3(&xmf3Result,
				XMLoadFloat3(&xmf3Vector) * fScalar);
		return xmf3Result;
	}
	...
	inline XMFLOAT3 CrossProduct(
		XMFLOAT3& xmf3Vector1,
		XMFLOAT3& xmf3Vector2,
...
namespace Vector4
{
	inline XMFLOAT4 Add(XMFLOAT4& xmf4Vector1, XMFLOAT4& xmf4Vector2) {
		XMFLOAT4 xmf4Result;
		XMStoreFloat4(&xmf4Result,
			XMLoadFloat4(&xmf4Vector1) + XMLoadFloat4(&xmf4Vector2));
		return xmf4Result;
	}
}
...
namespace Matrix4x4
{
	...
	inline XMFLOAT4X4 Multiply(XMFLOAT4X4& xmmtx4x4Matrix1, XMMATRIX& xmmtxMatrix2) {
		XMFLOAT4X4 xmmtx4x4Result;
		XMStoreFloat4x4(&xmmtx4x4Result,
			XMLoadFloat4x4(&xmmtx4x4Matrix1) * xmmtxMatrix2);
		return xmmtx4x4Result;
	}
	...
	inline XMFLOAT4X4 Multiply(XMMATRIX& xmmtxMatrix1, XMFLOAT4X4& xmmtx4x4Matrix2) {
		XMFLOAT4X4 xmmtx4x4Result;
		XMStoreFloat4x4(&xmmtx4x4Result,
			xmmtxMatrix1 * XMLoadFloat4x4(&xmmtx4x4Matrix2));
		return xmmtx4x4Result;
	}
	...
	inline XMFLOAT4X4 LookAtLH(
		XMFLOAT3& xmf3EyePosition,
		XMFLOAT3& xmf3LookAtPosition,
